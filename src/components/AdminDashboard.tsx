            ...
            {activeTab === 'users' && hasMore && (
              <div className="flex justify-center">
                <button
                  ...
                  className="flex items-center gap-2 px-6 py-2 bg-zinc-800 hover:bg-zinc-700 text-zinc-300 border border-zinc-700 rounded font-mono text-sm transition-colors disabled:opacity-50"
                >
                  {loadingMore ? (
